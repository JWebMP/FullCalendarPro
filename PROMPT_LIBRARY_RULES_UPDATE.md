...
- Library name: FullCalendar Pro
- Current/new version: 2.0.0-SNAPSHOT
- Repository URL / path: https://github.com/JWebMP/FullCalendarPro.git
- Rules Repository Location: ./rules (submodule https://github.com/GuicedEE/ai-rules.git)
- Short description: The JWebMP FullCalendar Pro extension module with GuicedEE wiring and TypeScript client assets
- Type:
...
- Component/topic areas (list): JWebMP core/client, FullCalendar/FullCalendar Pro widgets, TypeScript client metadata, Angular 20 integrations, GuicedEE client wiring (module scan + page configurator), Log4j2 logging + JSpecify, Maven build + GitHub Actions, Jacoco + Java Micro Harness + BrowserStack, Docs-as-Code architecture & stage-gated policy
