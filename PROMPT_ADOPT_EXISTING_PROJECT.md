...
- Repository URL / local path: https://github.com/JWebMP/FullCalendarPro.git
- Org and project name: JWebMP / FullCalendar Pro
- Short description: The JWebMP FullCalendar Pro extension library for the FullCalendar addon
